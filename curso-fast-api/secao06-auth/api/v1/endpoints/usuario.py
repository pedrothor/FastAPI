...
from schemas.usuario_schema import UsuarioSchemaBase, UsuarioSchemaCreate, UsuarioSchemaUp, UsuarioSchemaArtigo
...
# GET Usuario
@router.get('/{usuario_id}', response_model=UsuarioSchemaArtigo, status_code=status.HTTP_200_OK)
